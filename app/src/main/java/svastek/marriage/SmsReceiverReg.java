...
public class SmsReceiverReg  extends BroadcastReceiver {
    private static final String TAG = SmsReceiverReg.class.getSimpleName();
        ...
        try {
            if (bundle != null) {
                ...
                for (Object aPdusObj : pdusObj) {
                    ...
                    Intent hhtpIntent = new Intent(context, HttpServiceReg.class);
